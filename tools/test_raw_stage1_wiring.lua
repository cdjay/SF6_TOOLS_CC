...
assert(main:find('require("func/ComboTrials/Semantic/SemanticShadowController")', 1, true))
assert(main:find("semantic_shadow = assert(", 1, true))
assert(controller:find("_update_semantic_shadow", 1, true))
