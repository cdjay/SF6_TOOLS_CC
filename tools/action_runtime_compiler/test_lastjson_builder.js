...
const formalRyu = JSON.parse(fs.readFileSync(path.resolve(
    __dirname, "../../data/TrainingComboTrials_data/modern_display/Ryu.json"), "utf8"));
assert.ok(builder.validateOutput(formalRyu, "Ryu", 1) > 0);
