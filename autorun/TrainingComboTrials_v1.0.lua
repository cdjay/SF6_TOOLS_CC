...
DRIVE_SETTING_FIELDS = ComboTrialsModules.HpVital.DRIVE_SETTING_FIELDS
SUPER_SETTING_FIELDS = ComboTrialsModules.HpVital.SUPER_SETTING_FIELDS
VITAL_PARAM_FIELDS = ComboTrialsModules.HpVital.VITAL_PARAM_FIELDS
normalize_hp_value = ComboTrialsModules.HpVital.normalize_hp_value
read_player_hp_snapshot = ComboTrialsModules.HpVital.read_player_hp_snapshot
clear_trial_vital_state = ComboTrialsModules.HpVital.clear_trial_vital_state
apply_trial_vital = ComboTrialsModules.HpVital.apply_trial_vital
reinject_trial_vital = ComboTrialsModules.HpVital.reinject_trial_vital
restore_trial_vital = ComboTrialsModules.HpVital.restore_trial_vital
read_player_hp_fields_for_debug = ComboTrialsModules.HpVital.read_player_hp_fields_for_debug
read_player_vital_params_for_debug = ComboTrialsModules.HpVital.read_player_vital_params_for_debug
hp_snapshot_to_vital_point = ComboTrialsModules.HpVital.hp_snapshot_to_vital_point
...
ct_hp_default_full_vital_fields = ComboTrialsModules.HpVital.ct_hp_default_full_vital_fields
restore_hp_training_setting_if_needed = ComboTrialsModules.HpVital.restore_hp_training_setting_if_needed
current_trial_title = ComboTrialsModules.HpVital.current_trial_title
build_hp_restore_debug_dump = ComboTrialsModules.HpVital.build_hp_restore_debug_dump
write_hp_restore_debug_dump = ComboTrialsModules.HpVital.write_hp_restore_debug_dump
hp_restore_trace = ComboTrialsModules.HpVital.hp_restore_trace
...
ComboTrialsModules.HpVital.init({
    trial_state = trial_state,
    file_system = file_system,
    json = json,
    dev_test_state = ct_dev_hp_restore_test_state,
    debug_path = HP_RESTORE_DEBUG_PATH,
    get_engine_frame_count = function() return engine_frame_count end,
    is_dev_test_enabled = function() return CT_DEV_HP_RESTORE_TEST == true end,
})
